...
//       mouseY,
//       0,
//       color(random(100, 255), random(100, 255), 0),
//     );
//     snakes.push(head);
//     // Body
//     for (let i = 1; i < 10; i++) {
...
//         if (
//           closestDist < 200 &&
//           frameCount - v.lastShotTime > 60 &&
//           v.vel.dot(toTarget) > 0
//         ) {
//           bullets.push(new Bullet(v.pos.x, v.pos.y, v.vel.heading()));
//           v.lastShotTime = frameCount;
//         }
...
//     if (s.index === 0) {
//       // Head - now using wander behavior instead of following mouse
//       s.wander();
...
//     s.update();
//     s.edges(); // Make snakes wrap around screen edges
//     s.show();
//   }
// }
...
//     );
//     snakes.push(head);
//     // Body - pass previous segment reference
//     let prev = head;
//     for (let i = 1; i < 10; i++) {
//       let segment = new Snake(mouseX + i * 10, mouseY, i, head.color, prev);
//       snakes.push(segment);
//       prev = segment;
//     }
//   } else if (currentTool.includes("Obstacle")) {
...
function draw() {
  // Semi-transparent background to show the page gradient
  background(0, 0, 0, 80);
...
// function draw() {
//   // Dark semi-transparent background to show the space image behind
//   //background(0, 0, 0, 50);
